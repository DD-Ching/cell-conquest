...
# ---- Mode switch ----
SMOKE_TEST_ONLY = True   # ⚠️ set False to run full training (6-8h)
...
MIN_PLAYERS   = 2
MAX_PLAYERS   = 6
ITERATIONS    = 2500   # ~6-8 hours on T4. Interruptible — ckpts saved every SAVE_EVERY.
""")
...
out_path = '/Users/ddh/Cell/train_full.ipynb'
